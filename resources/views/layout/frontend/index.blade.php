        ...
        <div class="banner">
            <ul>
                <li data-transition="fade" data-slotamount="7" class="slide" data-slide=''>
                    <img alt="" src=" {{ URL::asset(config('asset.img') . 'avengers-character-poster-banner.jpeg') }}">
                    <div class="caption slide__video" data-x="0" data-y="0" data-autoplay='true'>
                        <video class="media-element"
                               ...
                               loop="loop"
                               muted=""
                               src="{{ URL::asset(config('asset.video') . 'marvel_studios.mp4') }}" >
                ...
                <li data-transition="fade" data-slotamount="7" class="slide fading-slide" data-slide=''>
                    <img alt='' src="{{ URL::asset(config('asset.img') . 'haiphuong.jpeg') }}">
                    <div class="caption slide__video" data-x="0" data-y="0" data-autoplay='true'>
                    </div>
                ...
                <li data-transition="fade" data-slotamount="7" class="slide" data-slide=''>
                    <img alt='' src="{{ URL::asset(config('asset.img') . 'alita.jpg') }}">
                    <div class="caption slide__name margin-slider"
                         data-x="right"
                         data-y="80"
    ...
    <section class="container">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-4 similar-wrap col--remove">
                <div class="post post--preview post--preview--wide">
                    <div class="post__image">
                        <img alt="" src="{{ asset(config('asset.img') . 'post-thor.jpg') }}">
            ...
            <div class="col-sm-4 similar-wrap col--remove">
                <div class="post post--preview post--preview--wide">
                    <div class="post__image">
                        <img alt="" src="{{ asset(config('asset.img') . 'post-annual.jpg') }}">
                        <div class="social social--position social--hide">
                            <span class="social__name">{{ __('Share:') }}</span>
                            <a href="#" class="social__variant social--first fa fa-facebook"></a>
                            <a href="#" class="social__variant social--second fa fa-twitter"></a>
            ...
            <div class="col-sm-4 similar-wrap col--remove">
                <div class="post post--preview post--preview--wide">
                    <div class="post__image">
                        <img alt="" src="{{ asset(config('asset.img') . 'post-awards.jpg') }}">
                        <div class="social social--position social--hide">
                            <span class="social__name">{{ __('Share') }}:</span>
                            <a href="#" class="social__variant social--first fa fa-facebook"></a>
                            <a href="#" class="social__variant social--second fa fa-twitter"></a>
